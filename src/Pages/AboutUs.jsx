          ...
          <Row>
            <Col lg='4'>
              <div className="teamBlock">
                <img src={founder} alt="founder" className="teamPic rounded-circle"/>
            ...
            <Col lg='4'>
              <div className="teamBlock">
                <img src={dev1} alt="dev1"   className="teamPic rounded-circle"/>
                <div className="memberDescription">
            ...
            <Col>
              <div className="teamBlock">
                <img src={dev2} alt="dev2"   className="teamPic rounded-circle"/>
                <div className="memberDescription">
                  <h3>Karl Earl</h3>
                  <p>CTO</p>
                </div>
            ...
            <Col lg='4'>
              <div className="teamBlock">
                <img src={dev3} alt="dev3"  className="teamPic rounded-circle" />
                <div className="memberDescription">
                  <h3>Jenna Hart</h3>
                  <p>Developer</p>
                </div>
            ...
            <Col lg='4'>
              <div className="teamBlock">
                <img src={dev4} alt="dev4"  className="teamPic rounded-circle" />
                <div className="memberDescription">
                  <h3>Slim Toumi</h3>
                  <p>Developer</p>
                </div>
            ...
            <Col lg='4'>
              <div className="teamBlock">
                <img src={dev5} alt="dev5" className="teamPic rounded-circle" />
                <div className="memberDescription">
                  <h3>Rosa Williams</h3>
                  <p>Developer</p>
                </div>
